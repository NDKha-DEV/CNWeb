...
// Kết nối MySQL
$mysqli = new mysqli("localhost", "root", "Ngdinhkha@1", "quiz"); // thay your_database bằng tên DB
if ($mysqli->connect_error) {
    die("Lỗi kết nối MySQL: " . $mysqli->connect_error);
}

// Tạo một quiz_id duy nhất cho lần thi này
$quiz_id = time(); // hoặc auto_increment, tùy bạn

// Chuẩn bị câu lệnh insert
$sql = "INSERT INTO quiz_results (quiz_id, question_text, user_answer, correct_answer, is_correct) 
        VALUES (?, ?, ?, ?, ?)";
